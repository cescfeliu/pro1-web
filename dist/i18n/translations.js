const translations = {
  ca: {
    ...
    contacte: { title: "Contacte", subtitle: "Tens un dubte o t'has quedat encallat? Envia'm un missatge i et contesto el més aviat possible.", nom: "Nom", nomPlaceholder: "El teu nom", correu: "Correu electrònic", correuPlaceholder: "el-teu-correu@exemple.com", missatge: "Missatge", missatgePlaceholder: "Explica'ns el teu dubte...", enviar: "Enviar missatge" },
  ...
  es: {
    ...
    contacte: { title: "Contacto", subtitle: "¿Tienes una duda o te has quedado atascado? Envíame un mensaje y te contesto lo antes posible.", nom: "Nombre", nomPlaceholder: "Tu nombre", correu: "Correo electrónico", correuPlaceholder: "tu-correo@ejemplo.com", missatge: "Mensaje", missatgePlaceholder: "Cuéntanos tu duda...", enviar: "Enviar mensaje" },
  ...
  en: {
    ...
    contacte: { title: "Contact", subtitle: "Got a question or stuck on something? Send me a message and I'll reply as soon as possible.", nom: "Name", nomPlaceholder: "Your name", correu: "Email", correuPlaceholder: "your-email@example.com", missatge: "Message", missatgePlaceholder: "Tell us your question...", enviar: "Send message" },
